...
MAX_KEYWORD_LENGTH = cvar.MAX_KEYWORD_LENGTH
...
class KWScorer(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, KWScorer, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, KWScorer, name)
    __repr__ = _swig_repr

    def __init__(self, alpha, beta, gamma, lm_path, vocabulary, base, check):
        this = _swig_decoders.new_KWScorer(alpha, beta, gamma, lm_path, vocabulary, base, check)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _swig_decoders.delete_KWScorer
    __del__ = lambda self: None

    def get_log_cond_prob(self, words):
        return _swig_decoders.KWScorer_get_log_cond_prob(self, words)

    def get_sent_log_prob(self, words):
        return _swig_decoders.KWScorer_get_sent_log_prob(self, words)

    def get_max_order(self):
        return _swig_decoders.KWScorer_get_max_order(self)

    def get_dict_size(self):
        return _swig_decoders.KWScorer_get_dict_size(self)

    def is_character_based(self):
        return _swig_decoders.KWScorer_is_character_based(self)

    def reset_params(self, alpha, beta, gamma):
        return _swig_decoders.KWScorer_reset_params(self, alpha, beta, gamma)

    def get_transition(self, state, character):
        return _swig_decoders.KWScorer_get_transition(self, state, character)

    def leaf_node(self, state):
        return _swig_decoders.KWScorer_leaf_node(self, state)

    def make_ngram(self, prefix):
        return _swig_decoders.KWScorer_make_ngram(self, prefix)

    def get_string(self, prefix):
        return _swig_decoders.KWScorer_get_string(self, prefix)

    def get_kw_score(self, str):
        return _swig_decoders.KWScorer_get_kw_score(self, str)

    def split_labels(self, labels):
        return _swig_decoders.KWScorer_split_labels(self, labels)
    __swig_setmethods__["alpha"] = _swig_decoders.KWScorer_alpha_set
    __swig_getmethods__["alpha"] = _swig_decoders.KWScorer_alpha_get
    if _newclass:
        alpha = _swig_property(_swig_decoders.KWScorer_alpha_get, _swig_decoders.KWScorer_alpha_set)
    __swig_setmethods__["beta"] = _swig_decoders.KWScorer_beta_set
    __swig_getmethods__["beta"] = _swig_decoders.KWScorer_beta_get
    if _newclass:
        beta = _swig_property(_swig_decoders.KWScorer_beta_get, _swig_decoders.KWScorer_beta_set)
    __swig_setmethods__["gamma"] = _swig_decoders.KWScorer_gamma_set
    __swig_getmethods__["gamma"] = _swig_decoders.KWScorer_gamma_get
    if _newclass:
        gamma = _swig_property(_swig_decoders.KWScorer_gamma_get, _swig_decoders.KWScorer_gamma_set)
    __swig_setmethods__["dictionary"] = _swig_decoders.KWScorer_dictionary_set
    __swig_getmethods__["dictionary"] = _swig_decoders.KWScorer_dictionary_get
    if _newclass:
        dictionary = _swig_property(_swig_decoders.KWScorer_dictionary_get, _swig_decoders.KWScorer_dictionary_set)
KWScorer_swigregister = _swig_decoders.KWScorer_swigregister
KWScorer_swigregister(KWScorer)
...
class BeamDecoder(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, BeamDecoder, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, BeamDecoder, name)
    __repr__ = _swig_repr

    def __init__(self, vocabulary, beam_size, cutoff_prob=1.0, cutoff_top_n=40, ext_scorer=None):
        this = _swig_decoders.new_BeamDecoder(vocabulary, beam_size, cutoff_prob, cutoff_top_n, ext_scorer)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
BeamDecoder_swigregister = _swig_decoders.BeamDecoder_swigregister
BeamDecoder_swigregister(BeamDecoder)
...
def ctc_beam_search_kw_decoder_batch(probs_split, vocabulary, beam_size, num_processes, cutoff_prob=1.0, cutoff_top_n=40, ext_scorer=None):
    return _swig_decoders.ctc_beam_search_kw_decoder_batch(probs_split, vocabulary, beam_size, num_processes, cutoff_prob, cutoff_top_n, ext_scorer)
ctc_beam_search_kw_decoder_batch = _swig_decoders.ctc_beam_search_kw_decoder_batch
